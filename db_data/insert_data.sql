...
(1, 'Superior with terrace and lake view', 24500, 5, '["Free Wi‑Fi", "Air conditioner (with climate control)"]', 7),
(1, 'Deluxe Plus', 22450, 10, '["Free Wi‑Fi", "Air conditioner"]', 8),
(2, 'Room for 2 people', 4570, 15, '[]', 9),
(2, 'Room for 3 people', 4350, 8, '[]', 10),
(3, 'Junior suite family room with 1 double bed', 7080, 20, '["Fridge"]', 11),
(3, 'Comfort 2-room suite', 9815, 10, '[]', 12),
(4, 'Standard double', 4300, 20, '["Free Wi‑Fi", "Fridge"]', 13),
(4, 'Standard improved PLUS', 4700, 35, '["Free Wi-Fi", "Fridge", "Jacuzzi", "Air conditioner"]', 14),
(5, 'Standard room with 2 single beds (breakfast included)', 5000, 15, '[]', 15),
(5, 'Premium junior suite (breakfast included)', 8000, 7, '[]', 16),
(6, 'Standard (standard housing)', 8125, 45, '[]', 17);
